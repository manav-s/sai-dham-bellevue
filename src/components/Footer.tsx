        ...
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/3 mb-4 md:mb-0">
            ...
            <div className="flex space-x-4">
              <a href="https://chat.whatsapp.com/GY0E24mpiiCLtDNf7cLWze" target={"_blank"}
                 className="text-green-500 hover:text-green-400"> {/* WhatsApp */}
                <FaWhatsapp className="w-6 h-6"/>
              </a>
              <a href="https://www.facebook.com/ShirdiSaiDhamBellevue" target={"_blank"}
                 className="text-blue-500 hover:text-blue-400"> {/* Facebook */}
                <FaFacebook className="w-6 h-6"/>
              </a>
              <a href="https://maps.app.goo.gl/Pi6b2idtonBY5afNA" target={"_blank"}
